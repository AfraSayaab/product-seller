                    ...
                    <TooltipProvider disableHoverableContent>
                        {NAV_ITEMS.map((item) => {
                            ...
                            const content = (
                                ...
                                >
                                    <Icon className={cn("h-4 w-4", active ? "text-background" : "text-foreground/80 group-hover:text-foreground")} />
                                    {!collapsed && <span className={cn(active ? "text-background" : "text-foreground/90")}>{item.label}</span>}
                                </button>
                            );
